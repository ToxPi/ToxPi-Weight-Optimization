...
data <- read.csv('1994-House_SupTab4.csv')
...
ggplot(rankDF, aes(x = gaRank, y = Rank, color = Source)) + 
  ...
  theme(plot.title = element_text(face = "bold", size = 11,hjust = 0.5),axis.text.x = element_text(color = c('black','black','black','red','red','black'))) +
